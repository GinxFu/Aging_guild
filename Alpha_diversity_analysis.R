...
# Alpha diversity data
  Alpha <- read.xlsx('R:\\文档\\6.Research\\2302_Age_CAG\\Alpha_CAG.xlsx', rowNames = TRUE)
  Alpha <- read.xlsx('R:\\文档\\6.Research\\2302_Age_CAG\\Alpha_allOTU.xlsx', rowNames = TRUE)
  Alpha <- read.xlsx('R:\\文档\\6.Research\\2302_Age_CAG\\Alpha_genus.xlsx', rowNames = TRUE)
...
Alpha_CAG <- read.xlsx('R:\\文档\\6.Research\\2302_Age_CAG\\Alpha_CAG.xlsx', rowNames = TRUE)
CAG_table <- read.xlsx('R:\\文档\\6.Research\\2302_Age_CAG\\CAG_table.xlsx', rowNames = T)
...
IA <- IA[-1,]
# write.xlsx(Coef, 'Dis_Alpha_ia-.xlsx')
